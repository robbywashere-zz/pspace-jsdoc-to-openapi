...
export declare type RequestHeadersHandler = (headers: RequestHeaders) => RequestHeaders;
export declare type ConfigureAgentHandler = (agent: SuperAgentStatic) => SuperAgentStatic;
export declare type ConfigureRequestHandler = (agent: SuperAgentRequest) => SuperAgentRequest;
export declare type CallbackHandler = (err: any, res?: request.Response) => void;
export declare type Error = {
    'code'?: number;
    'message'?: string;
};
export declare type JobsArtifactsDestroyRequestBody = {
    'files'?: string;
};
...
export declare type JobsCreateRequestBody = {
    'cluster'?: string;
    'clusterId'?: string;
    'codeCommit'?: string;
    'command'?: string;
...
export declare type JobsShowResponse = {
    'artifactsDirectory'?: string;
    'cluster'?: string;
    'container'?: string;
    'dtCreated'?: string;
...
export declare type LoginUserRequestBody = {
    'apiToken'?: string;
    'email': string;
    'password': string;
};
...
export declare type MachinesCreateRequestBody = {
...
export declare type MachinesDestroyRequestBody = {
...
export declare type MachinesShowResponse = {
    'agentType'?: string;
    'autoSnapshotFrequency'?: number;
    'autoSnapshotSaveCount'?: number;
    'cpus'?: number;
...
export declare type MachinesUpdateRequestBody = {
    'autoSnapshotFrequency'?: number;
    'autoSnapshotSaveCount'?: number;
    'dynamicPublicIp'?: boolean;
    'machineName'?: string;
...
export declare type ScriptsCreateRequestBody = {
    'isEnabled'?: boolean;
    'machineId'?: string;
    'runOnce'?: boolean;
 ...
 */
export declare class PaperspaceApi {
    private logger?;
    private domain;
    private errorHandlers;
    private requestHeadersHandler?;
    private configureAgentHandler?;
    private configureRequestHandler?;
    constructor(domain?: string, logger?: Logger);
    getDomain(): string;
    addErrorHandler(handler: CallbackHandler): void;
    setRequestHeadersHandler(handler: RequestHeadersHandler): void;
    setConfigureAgentHandler(handler: ConfigureAgentHandler): void;
    setConfigureRequestHandler(handler: ConfigureRequestHandler): void;
    private request;
    /**
